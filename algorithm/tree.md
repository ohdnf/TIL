...
<img src="https://adrianmejia.com/images/balanced-vs-non-balanced-tree.jpg" alt="img" style="zoom:80%;" />
...
<img src="assets/avl_bf.png" alt="avl balance factor" />
...
균형 이진 탐색 트리에서는 노드의 삽입, 삭제 작업 후 균형 인수를 확인해 균형을 맞추는 재구성 작업이 필요하다. AVL 트리는 **회전(Rotation) 연산**을 통해 불균형을 해결한다.

#### LL 유형

<img src="assets/avl_ll.png" alt="avl ll" />
...
<img src="assets/avl_rr.png" alt="avl rr" />
...
<img src="assets/avl_lr.png" alt="avl lr" />
...
<img src="assets/avl_rl.png" alt="avl rl" />
...
>
> 삽입, 삭제, 검색에서 최악의 경우에도 일정한 실행 시간을 보장한다.

#### 특성(Properties)

- 모든 노드는 **레드** 혹은 **블랙** 중 하나다.
- 루트 노드는 **블랙**이다.
- 모든 리프 노드들(Nil, Null)은 **블랙**이다.
- **레드** 노드의 양쪽 자식노드는 언제나 모두 **블랙**이다.
- 따라서 **레드** 노드끼리는 부모-자식 관계가 될 수 없다.
- 모든 리프 노드에서 루트 노드까지 가는 경로에서 만나는 **블랙** 노드의 개수는 같다.
